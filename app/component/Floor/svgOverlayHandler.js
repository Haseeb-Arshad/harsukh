...
export const handleSvgOverlay = (viewer, imageName, setActivePolygon, setPopupPosition, apartmentData) => {
    ...
    // const floorData = apartmentData[imageName] || [];
    ...
    polygons.forEach(polygon => {
        ...
        console.log(floorApartments)
        const apartmentInfo = floorApartments.find(apt => apt['Apartmentno'].toString() === dataImage);
        ...
        if (apartmentInfo) {
            ...
            const handleButtonClick = (e) => {
                ...
                // setActivePolygon({
                //     id: dataImage,
                //     bedroom: apartmentInfo.Bedrooms,
                //     netArea: apartmentInfo.Area,
                //     grossArea: apartmentInfo.Area,
                //     totalArea: apartmentInfo.Area,
                //     status: 'Available'
                // });
                
                // setPopupPosition({ 
                //     x: e.clientX,
                //     y: e.clientY + 20 // Offset to position popup below the button
                // });
            };
            ...
            const updateButtonPosition = () => {
                ...
                const pixelPoint = viewer.viewport.viewportToWindowCoordinates(viewportPoint);
            ...
            viewer.addHandler('update-viewport', updateButtonPosition);
        }
    });

    // Add SVG as an overlay
...
function getCenterOfPolygon(points) {
  ...
  const getSvgContent = (imageName) => {
    ...
    secondFloor: ` <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 10000 10000" preserveAspectRatio="none">
      ...
      firstFloor: ` <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 10000 10000" preserveAspectRatio="none">
      ...
      groundFloor: ` <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 10000 10000" preserveAspectRatio="none">
    ...
    basement3: `
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 10000 10000" preserveAspectRatio="none">
        <polyline data-image="81" data-tip="penthouse06" class="${styles.st0}" points="211.91 198.55 224.85 198.55 224.85 169.96 311.15 169.96 311.15 193.96 354.55 193.96 354.55 240.25 300.77 240.25 300.77 276.34 321.53 276.34 321.53 495.83 203.66 495.83 203.66 492.94 199.19 492.81 199.19 206.6 211.91 206.6"/>
        <polygon data-image="82" data-tip="penthouse06" class="${styles.st0}" points="429.49 169.96 429.49 198.81 453.49 198.81 454.21 198.81 454.21 465.3 410.6 465.3 410.6 451.57 321.53 451.57 321.53 276.34 300.77 276.34 300.77 240.25 354.55 240.25 354.55 193.96 354.55 193.45 429.49 169.96"/>
        ...
        <polygon data-image="84" data-tip="penthouse06" class="${styles.st0}" points="601.83 202 685.32 202 685.32 226 712.64 226 712.64 531.66 582.13 531.66 582.13 230.72 601.79 230.72 601.83 202"/>
        <path data-image="85" data-tip="penthouse06" class="${styles.st0}" d="M712.64,226H756v12.73h44.3V361.28h52.43V485.19h-6.3v46.47H712.64Z"/>
