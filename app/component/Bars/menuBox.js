...
const MenuBox = ({handleOverlay, isActive, translations, toggleLanguage, overlay, fullScreen, toggleFullScreen}) => {
  

    return (
    <>
    <div className={`${styles.menuOptionContainer} ${isActive ? styles.active : ''}`}>
