...
import FloorMenu from '@/app/component/ui/floor/testFloorMenu';
import styles from "@/styles/ImageBackground.module.css";
import Loading from '@/app/component/ui/Loading/Loading';
import Head from 'next/head';

const Floor = dynamic(() => import('@/app/component/modules/FloorLayout/floortest'), {
  loading: () => <Loading />,
  ssr: false,
});
...
const FloorPage = ({ amenityClicked, updateAmenityClicked }) => {
  ...
  const floor = pathname.split('/')[2].toLowerCase();
