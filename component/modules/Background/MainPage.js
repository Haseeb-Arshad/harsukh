...
const FavButton = dynamic(() => import("@/component/Icons/favButton"), { ssr: false });
const MenubarButton = dynamic(() => import("@/component/Icons/menuBarBtn"), { ssr: false });
const AmenityGrid = dynamic(() => import("@/component/ui/Amenities/AmenityGrid"), { ssr: false });
const ContactBox = dynamic(() => import("@/component/ui/Bars/contactBox"), { ssr: false });
const FilterBox = dynamic(() => import("@/component/ui/Bars/filterBox"), { ssr: false });
// const MenuBox = dynamic(() => import("@/app/component/Bars/menuBox"), { ssr: false });
const AmenityBtn = dynamic(() => import("@/component/Icons/AmenityBtn"), { ssr: false });
const ApartmentListing = dynamic(() => import("@/component/ui/Reserve/ApartmentListing"), { ssr: false });
const ElevationBox = dynamic(() => import("@/component/ui/Bars/elevationBox"), { ssr: false });
const Loader = dynamic(() => import("@/component/ui/Loading/Loading"), { ssr: false });
const ContactUsPopup = dynamic(() => import("@/component/modules/contactus/page"), { ssr: false });
...
export default function MainPage() {
  ...
  const [elevationArray, setElevationArray] = useState([
    { id: "2", label: translations["mapview"], route: "/map-view" },
  ...
  useEffect(() => {
    ...
    setElevationArray([
      { id: '2', label: language ? ur['mapview'] : en['mapview'], route: '/map-view' },
  ...
  return (
    <>
      ...
      <div
        ref={containerRef}
        className={`${styles.backgroundImageContainer} ${isFormOpen ? styles.blur : ""
          }`}
      >
        ...
        {!isMobile && (
          <>
            ...
            <div className={styles.container}>
              ...
              <div
                className={`${styles.buttonss} ${styles.formButton} ${isFormHovered ? styles.expanded : ""
                  }`}
